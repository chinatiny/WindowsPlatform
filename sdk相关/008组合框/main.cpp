	...
	)
{
	...
	case WM_INITDIALOG:
	{
						  ...
						  //combox_addstring
						  TCHAR *szCity[] = { _T("北京"), _T("天津"), _T("石家庄") };
						  for (int i = 0; i < 3; ++i)
						  {
							  // 预设选项
							  SendDlgItemMessage(hwndDlg, IDC_COMBO1, CB_ADDSTRING, 0, (LPARAM)szCity[i]);
						  }
						  // 设置默认选项
	...
	case WM_COMMAND:
	{
					   ...
					   case IDC_BUTTON1:
					   {
										   // 获取故乡
										   TCHAR szCity[1024] = {};
										   GetDlgItemText(hwndDlg, IDC_COMBO1, szCity, 1024);
										   MessageBox(hwndDlg, szCity, TEXT("故乡"), MB_OK);
					   }
						   break;
					   default:
						   break;
